...
const client = new Client(
  {
    ...
    presence: {
      activities: [{
        name: "eure mails | DM Me for Mail!",
        type: 2,
...
client.on('interactionCreate', async (interaction) => {
  ...
  if (command === "ping") {
            ...
            .addFields(
              {
                ...
                value: "<a:l1:1200140128534941716> <:a1:1200140095248945162>If you haven't provided the category ID in config.js file, use the slash command </setup:1202311301330640932> instead."
              },
              {
                name: "Creating a new mail:",
                value: "<a:l1:1200140128534941716> <:a1:1200140095248945162>To create a mail, DM anything to me and a Mail channel should be created automatically with your account ID. You can upload medias, they should work."
              },
              {
                name: "Closing a mail:",
                value: "<a:l1:1200140128534941716> <:a1:1200140095248945162>If you want to close a Mail from DMs, click on the gray button \"Close\". Else, if you want to close a Mail in Text Channel, go to the Mail channel and click on the red button \"Close\". If it replies with \"This interaction failed\", use the slash command \`/close\` instead."
              },
              {
                name: "Ban/Unban a user from using the ModMail system.",
                value: "<a:l1:1200140128534941716> <:a1:1200140095248945162>To ban a user, use the slash command </ban:1202311301330640930>. Else, use the slash command </unban:1202311301330640931>."
              },
              {
                name: "Am I allowed to share this code?",
                value: "<a:l1:1200140128534941716> <:a1:1200140095248945162>Unfortunately, you are not allowed to reshare this code from Alaindev.lord Please DM him and ask the permission to share, else you will get a copyright warning from him. Thanks :)"
              }
            )
            .setColor('Blue')
            .setFooter(
              {
                text: "Developed by: Alaindev.lord"
              }
            )
        ],
        ephemeral: true
    ...
    return interaction.reply(
      {
        embeds: [
          new EmbedBuilder()
            ...
            .setTitle("<:cmds:1200140097060868226> <:a1:1200140095248945162>List of available commands:")
    ...
    if (!reason) correctReason = '<:wrong:1200140144334864394> <:a1:1200140095248945162>No reason was provided.';
    ...
    ) return interaction.reply(
      {
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(`<:wrong:1200140144334864394> <:a1:1200140095248945162>Sorry, I can't let you to use this command because you need ${bold(config.Modmail.INTERACTION_COMMAND_PERMISSIONS.join(', '))} permissions!`)
            .setColor('Red')
        ],
        ephemeral: true
      }
    ...
    return interaction.reply(
      {
        embeds: [
          new EmbedBuilder()
            .setDescription(`<:correct:1200140110574932078> <:a1:1200140095248945162>That user has been successfully banned. Reason: ${bold(correctReason)}`)
            .setColor('Green')
        ],
        ephemeral: true
      }
    ...
    if (!bannedCheck) return interaction.reply(
      {
        embeds: [
          new EmbedBuilder()
            .setDescription(`<:wrong:1200140144334864394> <:a1:1200140095248945162>That user is already unbanned.`)
            .setColor('Red')
        ],
        ephemeral: true
      }
    ...
    return interaction.reply(
      {
        embeds: [
          new EmbedBuilder()
            .setDescription(`<:correct:1200140110574932078> <:a1:1200140095248945162>That user has been successfully unbanned.`)
            .setColor('Green')
        ],
        ephemeral: true
      }
      ...
      interaction.reply(
        {
          embeds: [
            new EmbedBuilder()
              .setDescription(`<a:l1:1200140128534941716> <:a1:1200140095248945162>There is already a modmail category named "ModMail". Replace the old category by a new category?\n\n:warning: If you click on **Replace**, all the mails text channels will be outside of category.`)
              .setColor('Red')
              .setFooter(
                {
                  text: "<:alert:1200140139712749619> <:a1:1200140095248945162>This request expires in 10 seconds, buttons won't respond to your actions after 10 seconds."
                }
              )
          ],
          components: [
      ...
      collectorREPLACE_CHANNEL.on('collect', async (i) => {
        ...
        if (ID == "replace_button_channel_yes") {
          i.update(
            {
              embeds: [
                new EmbedBuilder()
                  .setDescription(`<a:l1:1200140128534941716> <:a1:1200140095248945162>Creating a new category... This may take a while!`)
                  .setColor('Yellow')
              ],
              components: [
                new ActionRowBuilder()
          ...
          if (config.Modmail.MAIL_MANAGER_ROLES) {
            ...
            roles.push("<:wrong:1200140144334864394> <:a1:1200140095248945162>No roles were added to config.js file");
          }
          ...
          interaction.editReply(
            {
              embeds: [
                new EmbedBuilder()
                  .setDescription(`<:correct:1200140110574932078> <:a1:1200140095248945162>Done, successfully created a mail category named **ModMail**.`)
                  .addFields(
                    { name: "Roles", value: roles.join(', ') + "." }
                  )
                  .setFooter(
                    {
                      text: "<:alert:1200140139712749619> <:a1:1200140095248945162>Please check the roles in the category channel, errors could happen in anytime."
                    }
                  )
                  .setColor('Green')
              ]
          ...
          i.update(
            {
              embeds: [
                new EmbedBuilder()
                  ...
                  .setFooter(
                    {
                      text: "<:build:1200140099581653092> <:a1:1200140095248945162>You can now click on \"Dismiss message\" below this embed message."
                    }
                  )
                  .setColor('Green')
              ],
...
client.on('messageCreate', async (message) => {
  ...
  if (message.channel.type == ChannelType.DM) {
      ...
      return message.reply(
        {
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription(`<:wrong:1200140144334864394> <:a1:1200140095248945162>Sorry, we couldn\'t create a mail for you because you are ${bold('banned')} from using the modmail system!`)
              .addFields(
    ...
    if (!channel) {
      ...
      if (message.attachments.size) embed.setImage(message.attachments.map(img => img)[450].proxyURL);

      message.react("<:chat:1200140134687965236>")
        .catch(() => { });
